...
<div class="accountsetting">
    ...
    <form id="newpass_form">
        <div class="input_group">
            ...
            <div class="grouppass">
                <input id="currentpass" class="password" type="password" name="currentpass" title="Your current password is incorrect" pattern="<?php echo $account['password'] ?>" required>
        ...
        <div class="input_group">
            ...
            <div class="grouppass">
                <input id="newpass" class="password" type="password" name="newpass" required>
                <span class="showpassword"><i class="fa-solid fa-eye"></i></span>
            </div>
            <div class="error"></div>
        </div>
        <div class="input_group">
            ...
            <div class="grouppass">
                <input id="confirmnewpass" class="password" type="password" name="confirmnewpass" required>
                <span class="showpassword"><i class="fa-solid fa-eye"></i></span>
            </div>
            <div class="error"></div>
        </div>
...
<script>
    ...
    Array.from(showpassword).forEach((item, index) => {
